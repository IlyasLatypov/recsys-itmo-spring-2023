...
my_tracks_redis = Redis(app, config_prefix="REDIS_MY_TRACKS")
...
catalog.upload_my_tracks(my_tracks_redis.connection)
...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        if treatment == Treatment.T1:
            recommender = MyRecommender(my_tracks_redis.connection, artists_redis.connection, recommendations_redis.connection, catalog)
        else:
